...
```bash
docker pull ghcr.io/hiway-media/crowdsim:1.31.1        # or :1.31, or :latest
...
docker run --rm --network host \
  ...
  ghcr.io/hiway-media/crowdsim:1.31.1 crowdsim load --profile /profile.json --target edge --peak 60
