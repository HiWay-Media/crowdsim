...
```bash
docker pull ghcr.io/hiway-media/crowdsim:1.20.4        # or :1.20, or :latest
...
docker run --rm --network host \
  ...
  ghcr.io/hiway-media/crowdsim:1.20.4 crowdsim load --profile /profile.json --target edge --peak 60
