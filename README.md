...
```bash
docker pull ghcr.io/hiway-media/crowdsim:1.34.0        # or :1.34, or :latest
...
docker run --rm --network host \
  ...
  ghcr.io/hiway-media/crowdsim:1.34.0 crowdsim load --profile /profile.json --target edge --peak 60
