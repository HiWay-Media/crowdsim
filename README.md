...
```bash
docker pull ghcr.io/hiway-media/crowdsim:1.40.2        # or :1.40, or :latest
...
docker run --rm --network host \
  ...
  ghcr.io/hiway-media/crowdsim:1.40.2 crowdsim load --profile /profile.json --target edge --peak 60
